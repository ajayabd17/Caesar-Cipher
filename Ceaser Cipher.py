...
result = []
while num < self.len:
rand_choice = "".join(random.choices(d_char,
k=self.len)[0:1]) result.append(rand_choice)
...
result = []
while num < self.len:
s_choice = "".join(random.choices(s_char,
k=self.len)[0:1]) b_choice = "".join(random.choices(b_char,
k=self.len)[0:1]) d_choice = "".join(random.choices(d_char,
k=self.len)[0:1]) result.append(s_choice)
result.append(b_choice)
result.append(d_choice)
num += 1
value = "".join(result[0 : self.len])
